...
},{className:"literal",begin:/(-)[\w\d]+/,relevance:0}]},m)}}})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
contains:p}}})());hljs.registerLanguage("nginx",(()=>{"use strict";return e=>{const n={
...
contains:[n.SHEBANG({binary:"ruby"})].concat(E).concat(b).concat(o)}}})());hljs.registerLanguage("fortran",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
relevance:0},a,c]}}})());hljs.registerLanguage("javascript",(()=>{"use strict"
...
endsParent:!0}]}]}}})());hljs.registerLanguage("qml",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
begin:"\\."+n.IDENT_RE,relevance:0},a,t,i],illegal:/#/}}})());hljs.registerLanguage("scheme",(()=>{"use strict";return e=>{
...
name:"Scheme",illegal:/\S/,contains:[e.SHEBANG(),a,i,l,g,d].concat(c)}}})());hljs.registerLanguage("swift",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(e){return a("(?=",e,")")}
...
starts:{end:/^(?![ ]{6})/,subLanguage:"julia"},aliases:["jldoctest"]}]})})());hljs.registerLanguage("vim",(()=>{"use strict";return e=>({name:"Vim Script",
keywords:{$pattern:/[!#@\w]+/,
...
className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("elixir",(()=>{"use strict";return e=>{
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("profile",(()=>{"use strict";return e=>({
...
end:"\\)$",excludeBegin:!0,excludeEnd:!0,relevance:0}]})})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("llvm",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
}],relevance:0}]}}})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
...
begin:"@[A-Za-z]+"}]}}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
},{begin:e.IDENT_RE+"::",keywords:{built_in:t}},{begin:"->"}]}}})());hljs.registerLanguage("django",(()=>{"use strict";return e=>{const t={
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[t]}]}}})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
contains:a,keywords:e,illegal:"\\S"}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("dns",(()=>{"use strict";return d=>({name:"DNS Zone",
...
},d.inherit(d.NUMBER_MODE,{begin:/\b\d+[dhwm]?/})]})})());hljs.registerLanguage("less",(()=>{"use strict"
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("awk",(()=>{"use strict";return e=>({name:"Awk",keywords:{
...
},e.REGEXP_MODE,e.HASH_COMMENT_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("diff",(()=>{"use strict";return e=>({name:"Diff",
...
end:/$/}]})})());hljs.registerLanguage("ocaml",(()=>{"use strict";return e=>({name:"OCaml",
...
relevance:0},{begin:/->/}]})})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
begin:t,end:a,contains:[n],relevance:5}])}}})());hljs.registerLanguage("reasonml",(()=>{"use strict";return e=>{
...
begin:/\{/,end:/\}/,skip:!0}].concat(g)},v]}}})());hljs.registerLanguage("typescript",(()=>{"use strict"
;const e="[A-Za-z$_][0-9A-Za-z$_]*",n=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],a=["true","false","null","undefined","NaN","Infinity"],s=[].concat(["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],["arguments","this","super","console","window","document","localStorage","module","global"],["Intl","DataView","Number","Math","Date","String","RegExp","Object","Function","Boolean","Error","Symbol","Set","Map","WeakSet","WeakMap","Proxy","Reflect","JSON","Promise","Float64Array","Int16Array","Int32Array","Int8Array","Uint16Array","Uint32Array","Float32Array","Array","Uint8Array","Uint8ClampedArray","ArrayBuffer","BigInt64Array","BigUint64Array","BigInt"],["EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"])
...
name:"TypeScript",aliases:["ts","tsx"]}),b}})());hljs.registerLanguage("r",(()=>{"use strict";function e(...e){return e.map((e=>{
...
begin:/\\./}]}]}}})());hljs.registerLanguage("dockerfile",(()=>{"use strict";return e=>({
...
aliases:["yml"],contains:b}}})());hljs.registerLanguage("dart",(()=>{"use strict";return e=>{const n={
...
contains:[{beginKeywords:"extends implements"},e.UNDERSCORE_TITLE_MODE]
},e.C_NUMBER_MODE,{className:"meta",begin:"@[A-Za-z]+"},{begin:"=>"}]}}})());hljs.registerLanguage("clojure",(()=>{"use strict";return e=>{
