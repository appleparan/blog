...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}}})());hljs.registerLanguage("llvm",(()=>{"use strict";function e(...e){
...
}],relevance:0}]}}})());hljs.registerLanguage("python",(()=>{"use strict";function e(e){
...
begin:/^\.\.\.(?=[ ]|$)/}]}]})})());hljs.registerLanguage("awk",(()=>{"use strict";return e=>({name:"Awk",keywords:{
...
},e.REGEXP_MODE,e.HASH_COMMENT_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("rust",(()=>{"use strict";function e(...e){
...
keyword:"Self",built_in:i}},{className:"punctuation",begin:"->"},n]}}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
contains:[{begin:/\\./}]}]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
begin:/\(/,end:/\)/,keywords:n,illegal:/["']/}]}]}}})());hljs.registerLanguage("elixir",(()=>{"use strict";return e=>{
...
name:"Elixir",keywords:i,contains:t}}})());hljs.registerLanguage("erlang",(()=>{"use strict";return e=>{
...
},contains:[u]},s,e.QUOTE_STRING_MODE,b,o,l,d,{begin:/\.$/}]}}})());hljs.registerLanguage("c",(()=>{"use strict";function e(e){
...
strings:i,keywords:u}}}})());hljs.registerLanguage("fortran",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
className:"variable.constant"},R,k,{match:/\$[(.]/}]}}})());hljs.registerLanguage("qml",(()=>{"use strict";function e(...e){
return e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null;var n
...
begin:"\\."+n.IDENT_RE,relevance:0},a,t,i],illegal:/#/}}})());hljs.registerLanguage("less",(()=>{"use strict"
...
contains:p}}})());hljs.registerLanguage("css",(()=>{"use strict"
...
begin:"\\b("+e.join("|")+")\\b"}]};var s}})());hljs.registerLanguage("kotlin",(()=>{"use strict"
...
end:"$",illegal:"\n"},o]}}})());hljs.registerLanguage("clojure",(()=>{"use strict";return e=>{
...
illegal:/\S/,contains:[f,i,m,p,c,u,l,o,d]}}})());hljs.registerLanguage("django",(()=>{"use strict";return e=>{const t={
...
className:"template-variable",begin:/\{\{/,end:/\}\}/,contains:[t]}]}}})());hljs.registerLanguage("matlab",(()=>{"use strict";return e=>{var a={relevance:0,
...
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"})})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})());hljs.registerLanguage("reasonml",(()=>{"use strict";return e=>{
...
begin:/\{/,end:/\}/,relevance:0,skip:!0}].concat(g)},v]}}})());hljs.registerLanguage("scala",(()=>{"use strict";return e=>{const n={
...
begin:"@[A-Za-z]+"}]}}})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
name:"Shell Session",aliases:["console","shellsession"],contains:[{
className:"meta",begin:/^\s{0,3}[/~\w\d[\]()@-]*[>%$#][ ]?/,starts:{
end:/[^\\](?=\s*$)/,subLanguage:"bash"}}]})})());hljs.registerLanguage("latex",(()=>{"use strict";function e(...e){
return"("+((e=>{const n=e[e.length-1]
;return"object"==typeof n&&n.constructor===Object?(e.splice(e.length-1,1),n):{}
})(e).capture?"":"?:")+e.map((e=>{return(n=e)?"string"==typeof n?n:n.source:null
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},n,r]}}})());hljs.registerLanguage("lisp",(()=>{"use strict";return e=>{
...
contains:[l,e.SHEBANG(),s,b,g,o,v,m,c]}}})());hljs.registerLanguage("scss",(()=>{"use strict"
...
relevance:0},{begin:/->/}]})})());hljs.registerLanguage("tcl",(()=>{"use strict";function e(...e){
...
variants:[a.inherit(a.QUOTE_STRING_MODE,{illegal:null})]},r]};var n}})());hljs.registerLanguage("apache",(()=>{"use strict";return e=>{const n={
...
name:"Scheme",illegal:/\S/,contains:[e.SHEBANG(),a,i,l,g,d].concat(c)}}})());hljs.registerLanguage("haskell",(()=>{"use strict";return e=>{const n={
...
}),n,{begin:"->|<-"}]}}})());hljs.registerLanguage("nginx",(()=>{"use strict";function e(e){
return n("(?=",e,")")}function n(...e){return e.map((e=>{
return(n=e)?"string"==typeof n?n:n.source:null;var n})).join("")}return a=>{
...
end:/$/}]})})());hljs.registerLanguage("dns",(()=>{"use strict";return d=>({name:"DNS Zone",
aliases:["bind","zone"],
...
},d.inherit(d.NUMBER_MODE,{begin:/\b\d+[dhwm]?/})]})})());hljs.registerLanguage("properties",(()=>{"use strict";return e=>{
...
begin:"\\\\\\n"}]}}},{className:"attr",begin:n+t+"$"}]}}})());hljs.registerLanguage("ini",(()=>{"use strict";function e(e){
return e?"string"==typeof e?e:e.source:null}function n(...n){
...
starts:{end:/$/,contains:[t,l,r,i,c,a]}}]}}})());hljs.registerLanguage("vim",(()=>{"use strict";return e=>({name:"Vim Script",
keywords:{$pattern:/[!#@\w]+/,
...
end:"\\)"}]},{className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("julia",(()=>{"use strict";return e=>{
...
starts:{end:/^(?![ ]{6})/,subLanguage:"julia"},aliases:["jldoctest"]}]})})());hljs.registerLanguage("profile",(()=>{"use strict";return e=>({
...
end:"\\)$",excludeBegin:!0,excludeEnd:!0,relevance:0}]})})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
